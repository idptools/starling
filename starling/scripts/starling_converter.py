...
from starling.utilities import parse_output_path
...
def numpy2starling():    
    ...
    # Initialize the argument parser
    parser = ArgumentParser(description="Convert nd.numpy array (generated by STARLING) files to a .staring file. Note this is ONLY to support backwards compatiblity for ensembles generated previously")
